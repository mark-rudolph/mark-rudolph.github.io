...
//    transform = " recede 4s ease-in-out;";
//    transform += " @-webkit-keyframes recede {";
//    transform += " 0% { -webkit-transform: rotateY(0deg) rotateX(0deg) }";
//    transform += " 100% { -webkit-transform: rotateY(" + dx + "deg) rotateX(" + dy + "deg) }}";
//    console.log(transform);
//    $('.cube').css('-webkit-animation', transform);
    active = true;
  });
